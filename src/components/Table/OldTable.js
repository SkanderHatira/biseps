...
const headCells = [
  ...
  { id: "lane", numeric: true, disablePadding: false, label: "Lane" },
  {
    id: "techrep",
    numeric: true,
  ...
  { id: "r1", numeric: true, disablePadding: false, label: "Forward Read" },
  { id: "r2", numeric: true, disablePadding: false, label: "Reverse Read" },
];
...
const EnhancedTableToolbar = (props) => {
  ...
  const { numSelected, addUnit } = props;
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar addUnit={addUnit} numSelected={selected.length} />
        <TableContainer>
          <Table
                ...
                .map((unit, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{unit.lane}</TableCell>
                      <TableCell align="right">{unit.techrep}</TableCell>
                      <TableCell align="right">{unit.biorep}</TableCell>
                      <TableCell align="right">{unit.r1}</TableCell>
                      <TableCell align="right">{unit.r2}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
