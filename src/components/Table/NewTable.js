...
export default function NewTable() {
  ...
  const result = units.reduce(function (r, o) {
    ...
    if (!helper[key]) {
      helper[key] = Object.assign({ samplePath }, o); // create a copy of o
      r.push(helper[key]);
    } else {
      helper[key].units[o.lane] = { fq1: o.fq1, fq2: o.fq2 };

      // helper[key].fq2 += o.fq2;
    }
  ...
  console.log(units.filter((unit) => unit.sample > 6));
  const removeUnit = () => {
